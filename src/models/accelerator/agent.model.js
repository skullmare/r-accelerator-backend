...
const AgentSchema = new mongoose.Schema({
    ...
    // Отдельный промпт для оценки завершённости этапа (используется моделью-
    // «оценщиком», чтобы решить, собрана ли вся нужная информация для
    // генерации артефакта). Необязательное; если не задан — оценка
    // опирается на completionCriteria.
