...
export async function createAgent(req, res) {
    try {
        const { name, description, role, avatar, openAiAssistantId, baseMessages } = req.validatedData.body;
        const agent = await StudyAgent.create({ name, description, avatar, openAiAssistantId, baseMessages });
