...
>   вместо последних.
>
> **Не исправлено** и остаётся актуальным: отсутствие валидации связности
> маршрута (`nextAgentId`), разъезд двух LLM-провайдеров на деплое и
> устаревшая `docs/open-questions.md`.
